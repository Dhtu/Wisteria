...
class MyTestCase(unittest.TestCase):
    ...
    def test1(self):
        m_table = Fd_table()
        m_table.put(Sock_fd_item(12,12,0,True))
    ...
    def test2(self):
        m_table = Fd_table()
        m_table.put(Sock_fd_item(12,12,0,False))
        ret = m_table.is_sock(Tps_item(12, 12, 5, True, "comm"))
    ...
    def test4_1(self):
        m_table = Fd_table()
        m_table.put(Sock_fd_item(12, 12, 0, True))
        m_table.put(Sock_fd_item(12, 12, 6, False))
        ret = m_table.is_sock(Tps_item(12, 12, 5, True, "comm"))
        self.assertEqual(True, ret)
    ...
    def test4_3(self):
        ...
        m_table.put(Sock_fd_item(12, 12, 0, True))
        m_table.put(Sock_fd_item(12, 12, 6, False))
        m_table.put(Sock_fd_item(12, 12, 9, False))
        ret = m_table.is_sock(Tps_item(12, 12, 8, True, "comm"))
        self.assertEqual(False, ret)
    ...
    def test4_4(self):
        ...
        m_table.put(Sock_fd_item(12, 12, 0, True))
        m_table.put(Sock_fd_item(12, 12, 6, False))
        m_table.put(Sock_fd_item(12, 12, 8, True))
    ...
    def test4_5(self):
        ...
        m_table.put(Sock_fd_item(12, 12, 6, False))
        m_table.put(Sock_fd_item(12, 12, 8, True))
        m_table.put(Sock_fd_item(12, 12, 10, False))
    ...
    def test5_1(self):
        ...
        m_table.put(Sock_fd_item(12, 12, 6, False))
        m_table.put(Sock_fd_item(12, 12, 8, True))
        m_table.put(Sock_fd_item(12, 12, 10, True))
        m_table.put(Sock_fd_item(12, 12, 11, False))
        m_table.put(Sock_fd_item(12, 12, 12, True))
        m_table.put(Sock_fd_item(12, 12, 13, True))
        m_table.put(Sock_fd_item(12, 12, 14, False))
        m_table.put(Sock_fd_item(12, 12, 15, True))
    ...
    def test5_2(self):
        ...
        m_table.put(Sock_fd_item(12, 12, 13, True))
        m_table.put(Sock_fd_item(12, 12, 14, False))
        m_table.put(Sock_fd_item(12, 12, 15, False))
        ret = m_table.is_sock(Tps_item(12, 12, 17, True, "comm"))
        self.assertEqual(False, ret)
    ...
    def test5_3(self):
        ...
        m_table.put(Sock_fd_item(12, 12, 12, True))
        m_table.put(Sock_fd_item(12, 12, 13, True))
        m_table.put(Sock_fd_item(12, 12, 14, True))
        m_table.put(Sock_fd_item(12, 12, 17, False))
